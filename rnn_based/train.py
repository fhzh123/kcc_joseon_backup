...
def main(args):
    ...
    dataset_dict = {
        'train': CustomDataset(train_src_list, train_trg_list, 
                               mask_idx=args.mask_idx, min_len=args.min_len, 
                               src_max_len=args.src_max_len, trg_max_len=args.trg_max_len),
        'valid': CustomDataset(valid_src_list, valid_trg_list,
                               mask_idx=args.mask_idx, min_len=args.min_len, 
                               src_max_len=args.src_max_len, trg_max_len=args.trg_max_len)
    }
    dataloader_dict = {
        ...
        for phase in ['train', 'valid']:
            ...
            for (src, trg, _, _) in tqdm(dataloader_dict[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    output = seq2seq(src, trg, teacher_forcing_ratio=teacher_forcing_ratio_)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', 
        default='./preprocessing/preprocessed_data_vocab_32000_hj_spm_kr_spm.pkl', 
